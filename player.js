                                                                                              ...
                                                                                              $scope.$apply(function () {
                                                                                                     ...
                                                                                                     //       getInfo();
                                                                                                            /*  $scope.result = function () {
                                                                                                             var fileList = JSON.parse(document.songInfoApplet.getFilePath());
                                                                                                             return fileList;
                                                                                                             };*/
                                                                                                //            $scope.fileListArray = fileList;
                                                                                                            // JSON.parse(document.songInfoApplet.getFilePath());
                                                                                                            });
                                                                                              });
                                    
                                    /*  $scope.tableElementsArray = [{columnName: 'Song', columnValue: '', columnType: 'TIT2'}, {columnName: 'Album', columnValue: '', columnType: 'TALB'},
                                     {columnName: 'Band', columnValue: '', columnType: 'TPE2'}, {columnName: 'Year', columnValue: '', columnType: 'TYER'}, {columnName: 'Genre', columnValue: '', columnType: 'TCON'}];
                                     
                                     $scope.callSongInfo = function (name) {
                                     var songInfo = JSON.parse(document.songInfoApplet.getSongInfo(name));
                                     alert("Info " + songInfo.TIT2);
                                     $scope.tableElementsArray = [{columnName: 'Song', columnValue: songInfo.TIT2, columnType: 'TIT2'}, {columnName: 'Album', columnValue: songInfo.TALB, columnType: 'TALB'},
                                     {columnName: 'Band', columnValue: songInfo.TPE2, columnType: 'TPE2'}, {columnName: 'Year', columnValue: songInfo.TYER, columnType: 'TYER'}, {columnName: 'Genre', columnValue: songInfo.TCON, columnType: 'TCON'}];
                                     };
